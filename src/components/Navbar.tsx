                ...
                <MaxWidthWrapper>
                    <div className="border-b border-gray-200">
                        <div className="flex h-16 items-center">
                            ...
                            <div className="hidden z-50 lg:ml-50 lg:block lg:self-stretch">
                                <NavItems />
                            </div>
                            <div className="ml-auto flex items-center">
                                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-end-6">
                                    {user ? null : <Link href="/sign-in" className={buttonVariants({ variant: "ghost" })}>Sign In</Link>}
                                    {user ? null : <span h-6 w-px bg-gray-200 aria-hidden="true" />}

      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-9xl tracking-tight font-bold text-gray-900 sm:text-6xl">
            <span className="text-violet-600">Picasso.com</span>
            <br></br>Your online plug for high-quality{" "}
            <span className="text-violet-600">musical assets</span>.
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to <b className="text-gray-900 font-bold">Vic</b>. Your
            trusted and verified instruments marketplace
          </p>
